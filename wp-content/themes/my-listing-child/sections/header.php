                ...
                <div class="logo">
                    ...
                    <?php if ( $data['logo'] ): ?>
                        ...
                        <a href="<?php echo esc_url( home_url('/') ) ?>" class="static-logo">
                            ...
                            <img id="myLogo" src="<?php echo esc_url( $data['logo'] ) ?>">
                    ...
                    <div class="user-area">
                        ...
                        <div class="user-profile-dropdown dropdown">
                            ...
                            <a class="user-profile-name" href="#" type="button" id="user-dropdown-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <div class="avatar">
                                    <?php $custom_picture = get_user_meta( $current_user->ID, '_mylisting_profile_photo_url', true );
                                    if ($custom_picture) { ?>
                                    <img src="<?php echo $custom_picture; ?>" alt="" width="100" height="100">
                                    <?php } ?>
                                </div>
