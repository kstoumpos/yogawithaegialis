...
class Woo_Hide_Shipping_Methods
{
     ...
     */
    protected  $version ;
    const  WCPFC_VERSION = WOO_HIDE_SHIPPING_METHODS_VERSION ;
    /**
    ...
    private function define_admin_hooks()
    {
        ...
        if ( !empty($page) && false !== strpos( $page, 'whsm' ) ) {
            $this->loader->add_filter( 'admin_footer_text', $plugin_admin, 'whsma_pro_admin_footer_review' );
        }
    }
    ...
    public function plugin_action_links( $actions )
    {
        $custom_actions = array(
            ...
            'docs'      => sprintf( '<a href="%s" target="_blank">%s</a>', esc_url( 'thedotstore.com/docs/plugin/hide-shipping-methods-for-woocommerce' ), __( 'Docs', $this->plugin_name ) ),
            'support'   => sprintf( '<a href="%s" target="_blank">%s</a>', esc_url( 'thedotstore.com/support' ), __( 'Support', $this->plugin_name ) ),
        );
