...
echo "<form method='post' action=''>";
	...
	echo "<h2>" . __('License', 'perfmatters') . "</h2>";
  	echo '<p class="perfmatters-subheading">' . __('Manage your Perfmatters license key and activation.', 'perfmatters') . '</p>';
		...
		echo "<tbody>";
			...
			echo "<tr>";
				...
				echo "<td>";
					...
					echo "<input id='perfmatters_edd_license_key' name='perfmatters_edd_license_key' type='password' class='regular-text' value='" . (!empty($license) ? 'yourawizardharry' : '') . "' />";
