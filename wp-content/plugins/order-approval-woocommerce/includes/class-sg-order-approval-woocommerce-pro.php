...
class Sg_Order_Approval_Woocommerce_Pro {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'plugin_action_links_' .SG_BASE_ORDER, $plugin_admin, 'oawoo_wc_gateway_plugin_links' );
		// add pro version purchase link in plugins
		$this->loader->add_filter('plugin_action_links_' . SG_BASE_ORDER, $plugin_admin, 'link_pro_purchase');
		// woo payment gateway
		...
		// add more links in plugins page
		$this->loader->add_filter( 'plugin_row_meta',$plugin_admin, 'oawoo_plugin_row_meta', 10, 2 );
		// Setting page 
		...
		$this->loader->add_action('admin_head',$plugin_admin, 'sg_custom_admin_css');
		$this->loader->add_action( 'woocommerce_admin_field_sidebar' , $plugin_admin,'freeship_add_admin_field_sidebar' );
