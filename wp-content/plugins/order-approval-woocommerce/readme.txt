...
1. Added new translation strings.updated POT file.
1. New feature : Order Approve and Reject Buttons in Order Edit Screen 


**2.0.4 - (05-01-2020)**

1. Tested upto wc 4.8 and wp 5.6
1. Tweak : Payment link is added  to email template for easy translation and customisation.
1. Tweak : Added setting page and support links.
...
1. Fix :  fixed translation issues.

**2.0.0 - (08-07-2020)**

1. Optimised and improved code base. Moving OOP to enhance features and maintainability.
1. Moving versioning style to https://semver.org/ 
1. Added option page for customising email subject and heading.
...
Added customer notification for new order.
